package cn.xxyangyoulin.test_widget.custom;
...
public class CourseView extends FrameLayout {
    ...
    private void init() {
        mCourseList.add(new Course(1,2,1,Color.RED));
        mCourseList.add(new Course(2,1,2,Color.BLUE));
        mCourseList.add(new Course(3,1,3,Color.GRAY));
        mCourseList.add(new Course(4,1,4,Color.GREEN));
        l("调用init");
        initPaint();
    }
